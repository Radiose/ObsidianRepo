...
Any $\vec{b} \in \mathbb{R}^n$ can be uniquely written as $\vec{b} = A \vec{x}$, thus B is also a [[Bijective Transformation]].
If $AB = I_{n}$, and A is a bijection, the then $BA I_{n}$ 
