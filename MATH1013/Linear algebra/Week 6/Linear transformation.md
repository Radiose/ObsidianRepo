...
![[Transformation]]
EG:
is $T: \mathbb{R}\to \mathbb{R}$ T(x) = 2x+3 a [[Linear transformation]]?
simple proof? Is $T(\vec{0})=\vec{0}$? No
Is $Tx = |x|$ a [[Linear transformation]]?
No, $|x+y| \not= |x|+|y|$

Given a description of a [[Linear transformation]], how to find the formula? 
