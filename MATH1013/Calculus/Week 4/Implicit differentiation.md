...
$\frac{d}{dx}\{y^4+x^3  \}=\frac{d}{dx}\{ x^2+\sin(3y)+8 \}$
...
```handdrawn-ink
{
	...
	"filepath": "attachments/Ink/Drawing/2026.3.17 - 9.15am.drawing",
	"width": 961.0023193359375,
	"aspectRatio": 1.7853379148321764
}
```