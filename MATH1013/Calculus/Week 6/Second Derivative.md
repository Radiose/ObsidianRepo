...
For example, the following graph![[Pasted image 20260331143417.png]]
 ...
 Although both are increasing, one "bends" up, and the other bends down. 
 That is, the tangent lines for $x^2$ lie beneath the function, while the tangent lines for $\sqrt{ x }$ lie above it.