...
A solution to an ODE is finding a function to solve it. 
For example, $y' = xy$ can be solved with y = $f(x)=6e^{x^2/2}$

Its important to note that $y' =f(x)$, which is finding an [[Indefinite integral|antiderivative]] is an example of an ODE
