...
this is a sequence on the mRNA that complementary base pairs with rRNA 


protein synthesis begins with the formation of a *pre-initiation complex*
30s subunit binds to mRNA before larger one does 
made possible by an initiation factor which binds to 30s [[Ribosomal subunit]] named **IF3**

IF3 helps keep 30s subunit disassociated from 50s subunit - keeps it available for protein synthesis 

once 30s is bound to mRNA - two other initiation factors come in

**n-formylmenthionine-tRNA** forms complex with IF2 by binding to initiation codon (AUG)
