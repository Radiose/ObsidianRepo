...
### MATH1013
The standard matrix of composed [[Linear transformation of R n]]s 
...
So, [[Matrix multiplication]] is essentially just related to composition of [[Linear transformation of R n]]s.

Thus, you can only multiply matrices together, if you can compose the matrices together as [[Linear transformation of R n]]s.

For this reason, a 3x2 and a 3x2 [[matrix]] cannot be multiplied together, as the dimensions dont obey the laws of [[composition of Functions|composition]] of [[Linear transformation of R n]].
