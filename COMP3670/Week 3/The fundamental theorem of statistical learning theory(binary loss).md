...
$8(N+1)^v e^{-N\epsilon^2/32}\le \delta$ does not depend on $P$, so you get a "worst case" N.
...
Most importantly, it does not say anything about the closeness of $\hat{h}_{n}$ to $f^*$.