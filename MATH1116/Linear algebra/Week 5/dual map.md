If $T \in\mathcal{L}(V,W)$, then the dual map of $T$ is the [[linear map]] $$T^V \in \mathcal{L}(W^V,V^V)$$ defined by $$T^V(\phi)=\phi \circ T$$where $$\phi:W\to \mathbb{F}\text{ (an element of the dual vs)}$$
