...
**HOWEVER**
$g_{n}$ is continuous $\forall n \in\mathbb{N}$, but $\lim_{ n \to \infty } g_{n}$ is not. This is because $g(x)$ is not continuous, and because pointwise convergence cannot assure this. 